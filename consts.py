...
MODEL_NAME_TO_FILE_NAME_MAP = {
    ...
    for k, v in {
        ...
        "UVR-MDX-NET-Inst_HQ_4": "UVR-MDX-NET Inst HQ 4",
        "UVR-MDX-NET_Crowd_HQ_1": "UVR-MDX-NET Crowd HQ 1",
        ...
        "model_bs_roformer_ep_937_sdr_10.5309.ckpt": "BS-Roformer-Viperx-1053",
...
DEFAULT_ARCH_TYPE = 'MDX-Net'
DEFAULT_MODEL_NAME = 'MDX23C-InstVoc HQ'
